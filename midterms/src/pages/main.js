...
export default function Main() {
  return (
    <Box sx={classes.bg}>
          ...
          >
            <Grid direction="column">
              ...
              <Grid>
                ...
                <Typography sx={{ color: "#676a6e", fontSize: 13 }}>
                  30 Reviews
                </Typography>
      ...
      >
        <Typography sx={{ color: "#676a6e", fontSize: 14 }}>
          Year & Section
        </Typography>
        <Typography sx={{ color: "#676a6e", fontSize: 14, marginLeft: 13 }}>
          Reviews
        </Typography>
        <Typography sx={{ color: "#676a6e", fontSize: 14, marginLeft: 11.5 }}>
          Rating
        </Typography>
      </Grid>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Typography
                sx={{ color: "#676a6e", marginTop: "2.1%", marginLeft: "4%" }}
              >
                1
              </Typography>
              <Avatar
              ...
              <Typography sx={{ color: "#676a6e", marginTop: "2.1%" }}>
                BSIT4B
              </Typography>
              <Typography
                sx={{
